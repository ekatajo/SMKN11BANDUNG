...
<div class="row">
        ...
        <div class="col-md-7">
            ...
            <a href="/kurikulum/kelas_siswa/{{ $siswa->kode_kelas }}/{{ $siswa->nis }}/pdf" target="_blank"><button type="button" class="btn btn-link" style="color:#dc3545;"><i class="fa-solid fa-file-pdf  fa-2xl"></i></i></button></a>
