...
<head>
  ...
  <meta content="" name="keywords">
    ...
    <!-- Favicons -->
  <link href="assets/img/20230131_170949.png" rel="icon">

  <!-- Google Fonts -->
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Inter&family=Nunito:ital,wght@0,200;0,300;0,400;0,500;1,200;1,300;1,400;1,500&display=swap" rel="stylesheet">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="/" class="logo d-flex align-items-center">
        ...
        <h3 style="color: #00022F;">Raport Diagnostik</h3>
      </a>
...
Excel dan PDF untuk Ekspor & Import dat</p>
  ...
  </section><!-- End Hero Section --><!-- End About Us Section -->
            ...
            <div class="accordion accordion-flush" id="faqlist">
              ...
              <div class="accordion-item">
                ...
                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                  Tujuan Kami Merancang Aplikasi Ini Agar Memudahkan Sekolah Untuk Melihat Karakter Para Siswanya Yang Baru Masuk Sekolah 
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-4">
                    <i class="bi bi-question-circle question-icon"></i>
                    Aplikasi Raport Diagnostik Ini Digunakan Untuk Apa?
                  </button>
                </h3>
              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-5">
                    <i class="bi bi-question-circle question-icon"></i>
                   Aplikasi Ini Diperuntukan Untuk Siapa?
                  </button>
                </h3>
              ...
              <div class="section-header">
        <a class="w-100 btn btn-lg btn-primary mt-3" href="/UserGuide">USER GUIDE</a>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container mt-5 mb-3">
      ...
      <div class="col-lg-2 col-md-12 footer-contact text-center text-md-start">
            <img src="assets/img/smk11.png" style="width: 125px;">
          </div>      
        <div class="col-lg-2 col-md-12 footer-contact text-center text-md-start">
            <img src="assets/img/kemdikbud.png" style="width: 150px;">
        </div>
        <div class="col-lg-5 col-md-12 footer-info">
          <p class="logo d-flex align-items-center">
            <span>Raport Diagnostik</span>
          </p>
          <p>
           Jl. Raya Cilember, RT.01/RW.04, Sukaraja, Kec. Cicendo, Kota Bandung, Jawa Barat 40153<br>
           <strong>Fax:</strong> 022-6613508<br>
            <strong>Telepon:</strong> (022) 6652442<br>
          </p>
