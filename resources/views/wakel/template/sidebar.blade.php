 <ul class="navbar-nav sidebar sidebar-dark accordion toggled" id="accordionSidebar" style="background-color:#00022F;">
     ...
     <hr class="sidebar-divider my-0">
            ...
            <li class="nav-item {{ Request::is('wakel/kelas_siswa*') ? 'active' : '' }}">
                <a class="nav-link" href="/wakel/kelas_siswa">
                    ...
                    <span>Siswa</span>
                        ...
                        <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item {{ Request::is('wakel/kelas_guru*') ? 'active' : '' }}">
                <a class="nav-link" href="/wakel/kelas_guru">
